...
public interface IDataServiceProvider
{
    ...
    Task<User> GetUserByAccountDataAsync(AccountData accountData);
    ...
    Task<Transaction> CreateTransactionAsync(Transaction newTransaction);
    ...
    Task<Appeal> CreateAppealAsync(Appeal newAppeal);
    #endregion
    ...
    Task<bool> IsUserExistsByNameAsync(string name);
    #endregion
}